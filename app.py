...
# Konverteeri kuupäevad õigesse formaati
...
# **1. Kasutaja sisestab route_id või trip_id**
selected_route_id = st.text_input("Sisesta route_id või trip_id")
...
if not filtered_routes.empty:
    ...
    if not filtered_stops.empty:
        ...
        # **5. Kuvame kalendri ja erandite info**
    ...
    # Kui `route_id` ei leita, siis proovime `trip_id` järgi
